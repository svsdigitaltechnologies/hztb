...
public class ConfigurationConstants {
	...
	public static final String HEADER_CONTENT_VALUE = ".header.content";
	public static final String HEADER_ACCEPT_VALUE = ".header.accept";
	public static final String X_VERSION_HEADER = "X-Version";
	public static final String HEADER_X_VERSION_VALUE = ".header.xversion";
	public static final String AUTHORIZATION_HEADER = "Authorization";
	public static final String HEADER_AUTHORIZATION_VALUE = ".header.authorization";
