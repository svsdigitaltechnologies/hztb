...
public final class Message implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2850373827903691115L;
	...
	public static final class Builder {
		...
		public Builder priority(Priority value) {
			...
			if (Priority.NORMAL.equals(value)) {
				priority = "normal";
			} else {
				priority = "high";
			}
	...
	public String toString() {
		...
		Optional.ofNullable(priority).ifPresent(p -> builder.append("priority=").append(priority).append(", "));
		Optional.ofNullable(contentAvailable)
				.ifPresent(p -> builder.append("contentAvailable=").append(contentAvailable).append(", "));
		Optional.ofNullable(collapseKey)
				.ifPresent(p -> builder.append("collapseKey=").append(collapseKey).append(", "));
		Optional.ofNullable(timeToLive).ifPresent(p -> builder.append("timeToLive=").append(timeToLive).append(", "));
		Optional.ofNullable(delayWhileIdle)
				.ifPresent(p -> builder.append("delayWhileIdle=").append(delayWhileIdle).append(", "));
		Optional.ofNullable(dryRun).ifPresent(p -> builder.append("dryRun=").append(dryRun).append(", "));
		Optional.ofNullable(restrictedPackageName)
				.ifPresent(p -> builder.append("restrictedPackageName=").append(restrictedPackageName).append(", "));
		Optional.ofNullable(notification)
				.ifPresent(p -> builder.append("notification=").append(notification).append(", "));
