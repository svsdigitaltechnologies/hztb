...
@RestfulTransformer(ServiceManagerRestfulEndpoint.CLICKATELL_GET)
@Component
public class ClickatellGETTransformer extends RestfulServiceAbstractTransformer<ClickatellRequest, ClickatellResponse> {
